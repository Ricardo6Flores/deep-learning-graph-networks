...
def crear_visualizacion_3d_epsilon(coords_en, coords_es, palabras_en, palabras_es, 
    ...
    return fig, conexiones_intra, conexiones_inter,  L1
...
def generar_conexiones_epsilon(coords_en, coords_es, palabras_en, palabras_es, 
    ...
    fig, conexiones_intra, conexiones_inter, L1 = crear_visualizacion_3d_epsilon(
...
archivo_epsilon, L1 = generar_conexiones_epsilon(
